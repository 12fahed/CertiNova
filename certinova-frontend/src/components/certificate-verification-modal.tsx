...
export function CertificateVerificationModal({
  ...
  const handlePaste = (e: React.ClipboardEvent<HTMLInputElement>) => {
    ...
    if (cleanUuid.length === 32) {
      ...
      // This is handled automatically since we don't return early
      // Actually since we preventDefault, we should do fallback
      // But it's easier to just fallback to letting the browser paste if it's not a full uuid match.
    }
  };
            ...
            >
              <div className="text-center">
                ...
                <p className="text-xs text-gray-500 mb-6">
                  Format: 279c109d-dd92-4bbd-9a53-648119ba8892
                </p>
              </div>
